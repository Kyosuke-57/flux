...
vi.mock("../../../../src/services/history", () => ({
  ...
  getActivityStatusLabel: vi.fn((s: string) => ({ completed: "完了", processing: "処理中", queued: "処理中", failed: "エラー", transcribed: "文字起こし済", pending: "未処理" } as Record<string, string>)[(s ?? "") as string] ?? s ?? ""),
}));
